...
import { RefreshCw, Play, BarChart3, Clock, CheckCircle, XCircle } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">İtiraf Yönetimi</h1>
          <p className="text-muted-foreground">Otomatik itiraf sistemi kontrolü</p>
        </div>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {new Date().getHours() < 7 ? '07:00' :
                 new Date().getHours() < 9 ? '09:00' :
                 new Date().getHours() < 11 ? '11:00' :
                 new Date().getHours() < 13 ? '13:00' :
                 new Date().getHours() < 15 ? '15:00' :
                 new Date().getHours() < 17 ? '17:00' :
                 new Date().getHours() < 19 ? '19:00' :
                 new Date().getHours() < 21 ? '21:00' :
                 new Date().getHours() < 23 ? '23:00' : '01:00'}
              </div>
